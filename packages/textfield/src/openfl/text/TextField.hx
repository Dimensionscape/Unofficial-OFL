...
class TextField extends InteractiveObject
{
	...
	**/
	...
	@:noCompletion private function __mouseScrollUpdate():Void{
	...
	@:noCompletion private function this_onMouseOut(event:MouseEvent):Void{
		//__frameTime = ((1000 / stage.frameRate)*.01);
		//addEventListener(Event.ENTER_FRAME, this_onEnterFrame);
		//addEventListener(MouseEvent.MOUSE_OVER, this_onMouseOver);
	}
	
	@:noCompletion private function this_onMouseOver(event:MouseEvent):Void{
		//removeEventListener(Event.ENTER_FRAME, this_onEnterFrame);
		//removeEventListener(MouseEvent.MOUSE_OVER, this_onMouseOver);
	}
